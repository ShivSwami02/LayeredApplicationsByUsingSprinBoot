...
public class TuristPlaceInfoOraDAO implements ITouristPlaceDAO{
	...
	private final static String Tp_Insert="INSERT INTO TURISTPLACE(TPID,TPNAME,TPLOCATION,TPCONTACT,TPSITE) VALUES(TP_Seq_1.NEXTVAL,?,?,?,?)";
	
	@Autowired
	private DataSource ds;

	
	public TuristPlaceInfoOraDAO() {
