...
@Profile({"uat","prod"})
public class EmployeeOraDAO implements IEmployeeDAO{
	@Autowired
     private DataSource ds;
	
	
	
	public  EmployeeOraDAO() {
		super();
		System.out.println("EmployeeOraDAO::0-Param Constructor");
	}
	
	public final static String GET_EMPS_QUERY="SELECT EMPNO,ENAME,JOB,SAL,DEPTNO FROM EMP WHERE UPPER(JOB) IN(?,?,?)ORDER BY JOB";
	public final static String Emp_Insert="INSERT INTO EMP(EMPNO, ENAME, JOB, SAL) VALUES(empno_seq1.NEXTVAL, ?, ?, ?)";
	@Override
