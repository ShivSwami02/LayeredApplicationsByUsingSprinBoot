...
@Repository("hosOraDAO")
@Profile({"prod","uat"})
public class HospitalDetailsORADAO implements IHospitalDetailsDAO {
	...
	private static final String Hos_Insert = "INSERT INTO HOSPITALDETAILS(HID,HNAME,HMOBILE,HMAIL,LOCATION) VALUES (HosSeq3.NEXTVAL,?,?,?,?)";

	

	public HospitalDetailsORADAO() {
		super();
		System.out.println("HospitalDetailsORADAO:0-ParamConstructor");
	}
